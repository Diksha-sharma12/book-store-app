...
const Banner = () => {
  return (
    ...
    <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10'>
       ...
       <p className='text-xl'>
        Lorem,ipsum dolor sit omet cnsecutor odipisicing .dolor ,et totam, tempora amet atque expedita coerupti totam
        sed pariotur corporis at veriam est voluptors animit
        </p>
