...
const Signup = () => {
  ...
  <div className="modal-box dark:bg-slate-900 dark:text-white">
    ...
    <div className='flex justify-around mt-4'>
        <button className='bg-pink-500 text-white rounded-md px-3 py-1 hover:bg-pink-700 duration-200 dark:bg-slate-900 dark:text-white'>Signup </button>
        <p className='text-xl'>Have account? { " "}<button className='underline text-blue-500'onClick={()=>
